...
namespace zoltan_csizmadia {
	...
	public:
		...
		static void LPCWSTR2wstring(LPCWSTR strW, std::wstring& str);
		// From unicode string to wstring
		static void Unicode2wstring(UNICODE_STRING* strU, std::wstring& str);

		//////////////////////////////////////////////////////////////////////////////////
		// File name conversion functions

		static BOOL GetDeviceFileName(LPCTSTR, std::wstring&);
		static BOOL GetFsFileName(LPCTSTR, std::wstring&);
	...
	public:
		std::vector< THREAD_INFORMATION > m_ThreadInfos;
		DWORD m_processId;
	};
	...
	public:
		...
		static BOOL GetTypeToken(HANDLE, std::wstring&, DWORD processId = GetCurrentProcessId());
		static BOOL GetTypeFromTypeToken(LPCTSTR typeToken, WORD& type);
		static BOOL GetNameByType(HANDLE, WORD, std::wstring& str, DWORD processId = GetCurrentProcessId());
		static BOOL GetName(HANDLE, std::wstring&, DWORD processId = GetCurrentProcessId());
		...
		static BOOL GetProcessPath(HANDLE h, std::wstring& strPath, DWORD processId = GetCurrentProcessId());

		//File related functions
		static BOOL GetFileName(HANDLE, std::wstring&, DWORD processId = GetCurrentProcessId());
	...
	public:
		DWORD m_processId;
		std::vector< MODULE_INFO > m_ModuleInfos;
	...
	public:
		DWORD m_processId;
		std::vector< WINDOW_INFO  > m_WindowInfos;
	};
}
#endif
